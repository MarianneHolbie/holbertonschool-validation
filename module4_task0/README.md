...
# Docker
Using Docker to provide the same build environment for everyone, including the CI/CD environment.
Using the official golang Docker Image, that should be used for the steps ```build```, ```unit-tests``` and ```integration-tests```
